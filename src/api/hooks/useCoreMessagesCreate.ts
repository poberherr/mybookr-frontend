...
import type {
  CoreMessagesCreateMutationRequest,
  CoreMessagesCreateMutationResponse,
} from "../types/CoreMessagesCreate";

type CoreMessagesCreateClient = typeof client<
  CoreMessagesCreateMutationResponse,
  never,
  CoreMessagesCreateMutationRequest
>;
 ...
 * @link /core/messages/
 */
export function useCoreMessagesCreate(
  options: {
    mutation?: UseMutationOptions<
      CoreMessagesCreate["response"],
      CoreMessagesCreate["error"],
      CoreMessagesCreate["request"]
    >;
