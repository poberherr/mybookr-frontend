...
import type {
  CoreBookingsDeleteMutationResponse,
  CoreBookingsDeletePathParams,
} from "../types/CoreBookingsDelete";

type CoreBookingsDeleteClient = typeof client<
  CoreBookingsDeleteMutationResponse,
  never,
  never
>;
 ...
 */
export function useCoreBookingsDelete(
  id: CoreBookingsDeletePathParams["id"],
  options: {
    mutation?: UseMutationOptions<
      CoreBookingsDelete["response"],
      CoreBookingsDelete["error"],
      CoreBookingsDelete["request"]
    >;
