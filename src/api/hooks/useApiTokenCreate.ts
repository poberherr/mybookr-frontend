...
import type {
  ApiTokenCreateMutationRequest,
  ApiTokenCreateMutationResponse,
} from "../types/ApiTokenCreate";

type ApiTokenCreateClient = typeof client<
  ApiTokenCreateMutationResponse,
  never,
  ApiTokenCreateMutationRequest
>;
 ...
 * @link /api/token/
 */
export function useApiTokenCreate(
  options: {
    mutation?: UseMutationOptions<
      ApiTokenCreate["response"],
      ApiTokenCreate["error"],
      ApiTokenCreate["request"]
    >;
