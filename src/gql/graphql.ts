...
export type CreateBookingMutationMutation = { __typename?: 'Mutation', createBooking: { __typename?: 'BookingResultType', bookingFlowToken: string, paymentIntentId: string, paymentClientSecret: string } };
