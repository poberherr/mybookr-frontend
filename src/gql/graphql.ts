...
export type ConfirmationEmailQueryQuery = {
  __typename?: "Query";
  experience?:
    | ({ __typename?: "Experience" } & {
                ...
                { kind: "Field", name: { kind: "Name", value: "description" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "dateAvailable" },
                      },
                      {
                        kind: "Field",
...
export const ConfirmationEmailQueryDocument = {
  kind: "Document",
  definitions: [
    {
  ...
  ConfirmationEmailQueryQuery,
  ConfirmationEmailQueryQueryVariables
>;
