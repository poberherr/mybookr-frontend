...
export type ExperienceItemFragment = { __typename?: 'Experience', id: string, title: string, description?: string | null, medias?: Array<{ __typename?: 'Media', url: string }> | null, location: { __typename?: 'Location', addressLineOne?: string | null, addressLineTwo?: string | null, city?: string | null, country?: string | null, federalState?: string | null, postalCode?: string | null }, activities: Array<{ __typename?: 'Activity', id: string, title: string, availabilities?: Array<{ __typename?: 'Availability', id: string, dateAvailable: any, pricePerUnit: number }> | null, medias?: Array<{ __typename?: 'Media', url: string }> | null }> } & { ' $fragmentName'?: 'ExperienceItemFragment' };

export type ListingsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ListingsQueryQuery = { __typename?: 'Query', experiences: { __typename?: 'QueryExperiencesConnection', edges: Array<{ __typename?: 'QueryExperiencesConnectionEdge', node: (
        { __typename?: 'Experience' }
