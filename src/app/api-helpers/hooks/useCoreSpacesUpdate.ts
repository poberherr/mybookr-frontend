...
import type {
  CoreSpacesUpdateMutationRequest,
  CoreSpacesUpdateMutationResponse,
  CoreSpacesUpdatePathParams,
} from "../types/CoreSpacesUpdate";

type CoreSpacesUpdateClient = typeof client<
  CoreSpacesUpdateMutationResponse,
  never,
  CoreSpacesUpdateMutationRequest
>;
 ...
 * @link /core/spaces/:id/
 */
export function useCoreSpacesUpdate(
  id: CoreSpacesUpdatePathParams["id"],
  options: {
    mutation?: UseMutationOptions<
      CoreSpacesUpdate["response"],
      CoreSpacesUpdate["error"],
      CoreSpacesUpdate["request"]
    >;
