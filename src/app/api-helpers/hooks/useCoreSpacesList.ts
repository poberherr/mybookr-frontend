...
type CoreSpacesListClient = typeof client<
  CoreSpacesListQueryResponse,
  never,
  never
>;
type CoreSpacesList = {
...
export function coreSpacesListQueryOptions(
  options: CoreSpacesList["client"]["parameters"] = {},
) {
 ...
 * @link /core/spaces/
 */
export function useCoreSpacesList<
  TData = CoreSpacesList["response"],
  TQueryData = CoreSpacesList["response"],
  TQueryKey extends QueryKey = CoreSpacesListQueryKey,
>(
  options: {
    query?: Partial<
      QueryObserverOptions<
        CoreSpacesList["response"],
        CoreSpacesList["error"],
        TData,
        TQueryData,
        TQueryKey
      >
...
export const coreSpacesListSuspenseQueryKey = () =>
  [{ url: "/core/spaces/" }] as const;
export type CoreSpacesListSuspenseQueryKey = ReturnType<
  typeof coreSpacesListSuspenseQueryKey
>;
export function coreSpacesListSuspenseQueryOptions(
  options: CoreSpacesList["client"]["parameters"] = {},
) {
 ...
 * @link /core/spaces/
 */
export function useCoreSpacesListSuspense<
  TData = CoreSpacesList["response"],
  TQueryKey extends QueryKey = CoreSpacesListSuspenseQueryKey,
>(
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<
  ...
  const query = useSuspenseQuery({
    ...(coreSpacesListSuspenseQueryOptions(
      clientOptions,
    ) as unknown as QueryObserverOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<QueryObserverOptions, "queryKey">),
