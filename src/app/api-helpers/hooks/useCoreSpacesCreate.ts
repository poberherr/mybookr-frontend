...
import type {
  CoreSpacesCreateMutationRequest,
  CoreSpacesCreateMutationResponse,
} from "../types/CoreSpacesCreate";

type CoreSpacesCreateClient = typeof client<
  CoreSpacesCreateMutationResponse,
  never,
  CoreSpacesCreateMutationRequest
>;
 ...
 * @link /core/spaces/
 */
export function useCoreSpacesCreate(
  options: {
    mutation?: UseMutationOptions<
      CoreSpacesCreate["response"],
      CoreSpacesCreate["error"],
      CoreSpacesCreate["request"]
    >;
