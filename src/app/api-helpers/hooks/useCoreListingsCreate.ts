...
import type {
  CoreListingsCreateMutationRequest,
  CoreListingsCreateMutationResponse,
} from "../types/CoreListingsCreate";

type CoreListingsCreateClient = typeof client<
  CoreListingsCreateMutationResponse,
  never,
  CoreListingsCreateMutationRequest
>;
 ...
 * @link /core/listings/
 */
export function useCoreListingsCreate(
  options: {
    mutation?: UseMutationOptions<
      CoreListingsCreate["response"],
      CoreListingsCreate["error"],
      CoreListingsCreate["request"]
    >;
