...
import type {
  CoreReviewsCreateMutationRequest,
  CoreReviewsCreateMutationResponse,
} from "../types/CoreReviewsCreate";

type CoreReviewsCreateClient = typeof client<
  CoreReviewsCreateMutationResponse,
  never,
  CoreReviewsCreateMutationRequest
>;
 ...
 * @link /core/reviews/
 */
export function useCoreReviewsCreate(
  options: {
    mutation?: UseMutationOptions<
      CoreReviewsCreate["response"],
      CoreReviewsCreate["error"],
      CoreReviewsCreate["request"]
    >;
