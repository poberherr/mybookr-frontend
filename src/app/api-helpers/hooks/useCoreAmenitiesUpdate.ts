...
import type {
  CoreAmenitiesUpdateMutationRequest,
  CoreAmenitiesUpdateMutationResponse,
  CoreAmenitiesUpdatePathParams,
} from "../types/CoreAmenitiesUpdate";

type CoreAmenitiesUpdateClient = typeof client<
  CoreAmenitiesUpdateMutationResponse,
  never,
  CoreAmenitiesUpdateMutationRequest
>;
 ...
 */
export function useCoreAmenitiesUpdate(
  id: CoreAmenitiesUpdatePathParams["id"],
  options: {
    mutation?: UseMutationOptions<
      CoreAmenitiesUpdate["response"],
      CoreAmenitiesUpdate["error"],
      CoreAmenitiesUpdate["request"]
    >;
