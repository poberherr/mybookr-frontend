...
import type {
  CoreWishlistsDeleteMutationResponse,
  CoreWishlistsDeletePathParams,
} from "../types/CoreWishlistsDelete";

type CoreWishlistsDeleteClient = typeof client<
  CoreWishlistsDeleteMutationResponse,
  never,
  never
>;
 ...
 */
export function useCoreWishlistsDelete(
  id: CoreWishlistsDeletePathParams["id"],
  options: {
    mutation?: UseMutationOptions<
      CoreWishlistsDelete["response"],
      CoreWishlistsDelete["error"],
      CoreWishlistsDelete["request"]
    >;
