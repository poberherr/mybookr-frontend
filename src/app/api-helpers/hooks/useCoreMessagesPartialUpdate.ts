...
import type {
  CoreMessagesPartialUpdateMutationRequest,
  CoreMessagesPartialUpdateMutationResponse,
  CoreMessagesPartialUpdatePathParams,
} from "../types/CoreMessagesPartialUpdate";

type CoreMessagesPartialUpdateClient = typeof client<
  CoreMessagesPartialUpdateMutationResponse,
  never,
  CoreMessagesPartialUpdateMutationRequest
>;
 ...
 */
export function useCoreMessagesPartialUpdate(
  id: CoreMessagesPartialUpdatePathParams["id"],
  options: {
    mutation?: UseMutationOptions<
      CoreMessagesPartialUpdate["response"],
      CoreMessagesPartialUpdate["error"],
      CoreMessagesPartialUpdate["request"]
    >;
  ...
  return useMutation({
    mutationFn: async (data) => {
      const res = await client<
        CoreMessagesPartialUpdate["data"],
        CoreMessagesPartialUpdate["error"],
        CoreMessagesPartialUpdate["request"]
      >({
        method: "patch",
