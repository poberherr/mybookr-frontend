...
import type {
  CoreAmenitiesDeleteMutationResponse,
  CoreAmenitiesDeletePathParams,
} from "../types/CoreAmenitiesDelete";

type CoreAmenitiesDeleteClient = typeof client<
  CoreAmenitiesDeleteMutationResponse,
  never,
  never
>;
 ...
 */
export function useCoreAmenitiesDelete(
  id: CoreAmenitiesDeletePathParams["id"],
  options: {
    mutation?: UseMutationOptions<
      CoreAmenitiesDelete["response"],
      CoreAmenitiesDelete["error"],
      CoreAmenitiesDelete["request"]
    >;
