...
import type {
  CoreMetadataUpdateMutationRequest,
  CoreMetadataUpdateMutationResponse,
  CoreMetadataUpdatePathParams,
} from "../types/CoreMetadataUpdate";

type CoreMetadataUpdateClient = typeof client<
  CoreMetadataUpdateMutationResponse,
  never,
  CoreMetadataUpdateMutationRequest
>;
 ...
 */
export function useCoreMetadataUpdate(
  id: CoreMetadataUpdatePathParams["id"],
  options: {
    mutation?: UseMutationOptions<
      CoreMetadataUpdate["response"],
      CoreMetadataUpdate["error"],
      CoreMetadataUpdate["request"]
    >;
